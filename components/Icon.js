...
`<svg width="134" height="122" viewBox="0 0 192 175" xmlns="http://www.w3.org/2000/svg">
  <g stroke-width="3" stroke="#4A90E2" fill="none" fill-rule="evenodd">
...
`,
    wait:
`<svg width="65" height="80" viewBox="0 0 68 83" xmlns="http://www.w3.org/2000/svg">
  <g fill-rule="nonzero" fill="#4A90E2">
